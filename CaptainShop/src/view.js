  ...
  function popup() {
    ...
    if (p.type === 'debug') {
      body = `<div style="display:flex;flex-direction:column;gap:12px;">
        ...
        <a href="../" class="pop-btn" style="display:block;background:#141a1f;border:1px solid #2a333c;color:#8b98a2;padding:22px;border-radius:6px;font-family:'Oswald',sans-serif;font-size:32px;cursor:pointer;text-decoration:none;margin-top:12px;">← На главную</a>
      </div>`;
