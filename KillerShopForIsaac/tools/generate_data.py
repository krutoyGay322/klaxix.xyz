# -*- coding: utf-8 -*-
"""Generates ../js/data.js for the Killer Shop (версия Айзека: 6 тиров S..F).

Scans:
  - KillerShopForIsaac/killerShopSpecificKillerPerks/<X> tier/*.png -> killer perk pools S..F
...
Run:  python -X utf8 tools/generate_data.py   (from KillerShopForIsaac/)
"""
import json
import os
import re
